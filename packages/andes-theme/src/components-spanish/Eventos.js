...
//filter
import useFilter from '../hooks/useFiltersYearsSpanish';
                            ...
                            arrEventsFiltered.length > 0 && arrEventsFiltered.map( event => (    
                                <EventContainer key={event[0].id}>
...

                                    {
                                        ...
                                        <a href={event[0].acf.link_pdf} rel="noopener noreferrer" target="_blank">Ver pdf</a>
                                        :null
                                    }
                            ...
                            <EventContainer>
                                ...
                                {arrEvenstOrderByDate[0].acf.link_video? 
...

                                    {
                                        ...
                                        <a href={arrEvenstOrderByDate[0].acf.link_pdf} rel="noopener noreferrer" target="_blank">Ver pdf</a>
                                        :null
                                    }
                    ...
                    <CalendarPastEvents>
                        ...
                        {FilterUI()}
                            ...
                            {isFilterYear ? 
                                ...
                                <div>
                                <h1>EVENTOS EN EL AÑO {category}</h1>
